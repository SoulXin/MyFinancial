    ...
    useFocusEffect(useCallback(() => {
        ...
        .then(res => {
            ...
            const loadData = async () => {
                try{
                    const response = await axios.get(`http://192.168.43.171:5000/financial/show_financial/expense/${res.user._id}`,{cancelToken : source.token});
                ...
                <View style = {styles.row_price_input}>
                    ...
                    <View style = {styles.container_submit}>
                        <TouchableOpacity 
                            ...
                            onPress = {() => handleAdd(user_Id,information,price,"expense",data,setPrice,setInformation,setData)}
                        >
